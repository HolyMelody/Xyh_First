...
class Topo(object):
    ...
    def get_graph(self):
        Matrix = np.array(np.ones((20,20))*9)
...
class MyController(app_manager.RyuApp):
    ...
    def packet_in_handler(self,event):
        ...
        if self.flag == False:
            ...
            print('path:  ',path)
            #给路径中交换机下发流表
            self.configure_path(path,event,'00:00:00:00:00:01','00:00:00:00:00:02')
            print('--------------------Configure done--------------------')

            
            #下发回路
            self.configure_path([(2,1,[2]),(1,2,[1])],event,'00:00:00:00:00:02','00:00:00:00:00:01')
            print('--------------------Configure done--------------------')
        ...
        if dst_mac in self.topo.host_mac_to.keys():
            ...
            shortest_path=self.topo.compute_flowTables(1,1)
