...
class SnakeGame:
    def __init__(self, seed=0, board_size=12, silent_mode=True):
        ...
        if not silent_mode:
            ...
            # Load sound effects
            mixer.init()
            self.sound_eat = mixer.Sound("C:/Users/xyh/Desktop/vscode/.vscode/py/Learning_Test/snake-ai-master/main/sound/eat.wav")
            self.sound_game_over = mixer.Sound("C:/Users/xyh/Desktop/vscode/.vscode/py/Learning_Test/snake-ai-master/main/sound/game_over.wav")
            self.sound_victory = mixer.Sound("C:/Users/xyh/Desktop/vscode/.vscode/py/Learning_Test/snake-ai-master/main/sound/victory.wav")
        else:
            self.screen = None
            self.font = None
